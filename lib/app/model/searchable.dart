...
extension SearchableUtil on Searchable {
  ...
  bool containsFuzzy(String key,
      {Iterable<String>? searchPropertiesEnable, FuzzyOptions? options}) {
    ...
    for (final p in searchPropertiesEnable) {
      ...
      if (property is String && property.containsFuzzy(key, options: options)) {
        match = true;
        break;
...
extension SearchableListUtil on Iterable<Searchable> {
  ...
  List<T> searchFuzzy<T extends Searchable>(String key,
