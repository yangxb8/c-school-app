...
// 🌎 Project imports:
import '../../core/theme/login_theme.dart' as theme;
import '../../core/utils/bubble_indication_painter.dart';
import '../../core/utils/index.dart';
import '../../core/values/icons/c_school_icons.dart';
import '../../global_widgets/progress_hud.dart';
import '../../global_widgets/separator.dart';
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (val) =>
                              controller.formTexts['loginEmail'] = val,
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: RequiredValidator(
                              errorText: 'login.common.error.required'.tr),
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (val) =>
                              controller.formTexts['signupName'] = val,
                          validator: MultiValidator([
                            RequiredValidator(
                                errorText: 'login.common.error.required'.tr),
                            MaxLengthValidator(50,
                                errorText: 'login.register.error.tooLong'.tr)
                          ]),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (val) =>
                              controller.formTexts['signupEmail'] = val,
                          validator: emailValidator,
                          keyboardType: TextInputType.emailAddress,
                          style: TextStyle(
                              fontFamily: 'WorkSansSemiBold',
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (val) => MatchValidator(
                                  errorText:
                                      'login.register.error.passwordConfirmError'
                                          .tr)
                              .validateMatch(
