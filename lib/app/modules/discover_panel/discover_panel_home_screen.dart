  ...
  void moveTo() {
    Navigator.push<dynamic>(
      ...
      MaterialPageRoute<dynamic>(
        builder: (BuildContext context) => SampleLectureScreen(),
      ),
    );
  }
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    SizedBox(
                      width: 60,
                      height: 60,
                      child: Icon(Icons.search, color: '#B9BABC'.toColor()),
                    )
                  ],
                ),
              ),
      ...
      child: Row(
        children: <Widget>[
          ...
          Container(
            width: 60,
            height: 60,
            child: Image.asset('assets/discover_panel/userImage.png'),
          )
        ],
      ),
    );
